<?php 
$x = 'Histórico de Relatórios (Consulta)'; 
...
<body>
   ...
   <!--::Inicio do Header::-->
    <header class="main_menu home_menu">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse"  role="menu" aria-labelledby="dLabel" id="navbarTogglerDemo03">
          <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
          <li class="nav-item"><a class="nav-link" id="link_ativo"  href="http://10.68.14.67/novosicob/consulta.php">Pág. Inicial<span class="sr-only">(current)</span></a></li>   
  ...
  <div class="bd-example">
    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" style="text-shadow: 2px 2px 5px black">
        <div class="carousel-item active" >
          <img src="imagens/slide_12.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block">
            <div class="sombra">
            <a href="http://10.68.14.67/novosicob/relat_gs.php">
            <h5 >Anexo III Art. 32</h5>
            <p > Gerar Relatório ANEXO III ART 32 </p>
            </a>
          </div>
          </div>
        </div>
        <div class="carousel-item">
          <img src="imagens/relat17.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block">
            <div class="sombra">
              <a href="http://10.68.14.67/novosicob/tratrec_load.php">
            <h5 >Tratamento de Reclamações Anexo III</h5>
            <p >Gerar Relatório de Tratamento de Reclamações Anexo III</p>
          </a>
          </div>
          </div>
        </div>
        <div class="carousel-item">
          <img src="imagens/slide_14.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block">
            <div class="sombra">
              <a href="http://10.68.14.67/novosicob/tratrec_load_anexo_i.php">
            <h5 >Tratamento de Reclamações Anexo I</h5>
            <p >Gerar Relatório de Tratamento de Reclamações Anexo I</p>
              </a>
          </div>
          </div>
        </div>
        <div class="carousel-item">
          <img src="imagens/adm02.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block">
            <div class="sombra">
              <a href="http://10.68.14.67/novosicob/gerar_relat.php">
            <h5>Incluir Usuário</h5>
            <p>Incluir Novo Usuário (Comum ou Adminsitrador) no Sistema [Adm]</p>
          </a>
          </div>
          </div>
        </div>
        <div class="carousel-item">
          <img src="imagens/bd03.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block">
            <div class="sombra">
              <a href="http://10.68.14.67/novosicob/relviolr.php">
            <h5>Enviar Arquivos Anexo III</h5>
            <p>Enviar Arquivos referentes ao Anexo III: EUSD, Anexo III, Violação de Serviço</p>
          </a>
          </div>
          </div>
        </div>
  ...
  <section class="corpo_meio">
          <nav class="navbar navbar-dark" style="background-color: #25179E;">
  <a class="navbar-brand" id="title01" href="http://10.68.14.67/novosicob/consulta.php">
    <div class="h4"> Histórico </div>
  </a>
</nav>
      <div class="container">
        ...
        <div class="row">
            ...
            <p class="title_topic"><div class="h3"  style="margin-top: 20px; float: left;"> Últimos Relatórios Emitidos </div></p>
  

         <table class="table table-bordered table-light table-hover" id="table01">
  ...
  <tbody>
  <? 
    $sql = "SELECT nomeArquivo, nomeUsuario, dataInsert FROM uploads GROUP BY dataInsert DESC LIMIT 10"; 
    $resultado = mysql_query($sql) or die(mysql_error()); 
    $cont = 1;
    while($registro = mysql_fetch_array($resultado)){ ?>
    <tr>
      <th scope="row"><? echo "$cont" ?></th>
      <td><? echo $registro['nomeArquivo']; ?></td>
      <td><? echo $registro['nomeUsuario']; ?></td>
      <td><? echo $registro['dataInsert']; ?></td>
    </tr>
