...
<body>
  ...
  <a class="navbar-brand" id="title01" href="http://10.68.14.67/novosicob/admuser.php">
    <div class="h4"> Incluir Usuário </div>
  </a>
</nav>
...
<div class="row">   
     ...
     <div class="userform"> <form style="margin-left: 45px; margin-top: 8px" class="formulariouser" action="caduser.php" method="POST">
  <div class="form-group row">
    <label for="inputEmail3" class="col-sm-2 col-form-label">Nome</label>
    <div class="col-sm-10">
      <input type="text" name="nome" class="col-sm-11 form-control"  placeholder="Ex: Daniel Pereira">
    </div>
  </div>
  <div class="form-group row">
    <label for="inputEmail3" class="col-sm-2 col-form-label">Login</label>
    <div class="col-sm-10">
      <input type="text" name="login" class="col-sm-11 form-control"  placeholder="Ex: 12345">
    </div>
  </div>
  <div class="form-group row">
    <label for="inputEmail3" class="col-sm-2 col-form-label">Departamento</label>
    <div class="col-sm-10">
      <input type="text" name="dep" class="col-sm-11 form-control"  placeholder="Ex: GPGC">
    </div>
  </div>
  <div class="form-group row">
    <label for="inputPassword3" class="col-sm-2 col-form-label">Senha</label>
    <div class="col-sm-10">
      <input type="password" class="col-sm-11 form-control" name="senha" id="inputPassword3" pattern=".{6,20}" placeholder="Min. 6 caracteres">
    </div>
  </div> 
  <div class="form-group row">
    <div class="col-sm-3">Nível de Usuário</div>
    <div class="col-sm-6">
      <div class="form-check">
        <input class="form-check-input" type="checkbox" id="gridCheck1" name="userType" value="2">
...
<a href="condeluser.php"><button type="button" class="btn btn-primary" style="position: absolute; margin-top: 390px; margin-left: 150px;">+ Consultar usu&aacute;rios</button></a>
