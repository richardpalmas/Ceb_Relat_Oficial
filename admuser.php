...
<body>
  ...
  <a class="navbar-brand" id="title01" href="http://10.68.14.67/novosicob/admuser.php">
    <div class="h4"> Administrar Sistema </div>
  </a>
</nav>
      <div class="container-fluid">
        ...
        <div class="row2">
          ...
          <figure id="figure_relat01"><a href="http://10.68.14.67/novosicob/condeluser.php"><img src="imagens/adm03.jpg" alt="imagem" class="img-thumbnail img_link"><figcaption class="figcaption2"> <div class="sombra_caption3"> Consultar ou Deletar Usuários </div> </figcaption></a></figure>

          <figure id="figure_relat01"><a href="http://10.68.14.67/novosicob/incuser.php"><img src="imagens/adm01.jpg" alt="imagem" class="img-thumbnail img_link"><figcaption class="figcaption2"> <div class="sombra_caption3"> Incluir Novo Usuário </div> </figcaption></a></figure>

          <figure id="figure_relat01"><a href="http://10.68.14.67/novosicob/addfer.php"><img src="imagens/calendar.jpg" alt="imagem" class="img-thumbnail img_link"><figcaption class="figcaption2"> <div class="sombra_caption3"> Atualizar Feriados </div> </figcaption></a></figure>
