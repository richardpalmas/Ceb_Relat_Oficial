...
<a class="navbar-brand" id="img_logo_main" href="consulta.php"><img id="img_logo" src="imagens/logo_ceb.png"></a>
  ...
  <section class="corpo_meio_relat_cort">
...
<div id="D4" style="display:none;margin-left: 7.5%; margin-top: 2.5%"><p align="left">  <button type="button" id="button_cort2" class="btn btn-primary" onClick="optionCheck8()">Veja cortes concluídos com e sem impedimento</button></p></div>
