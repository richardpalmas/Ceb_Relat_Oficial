...
<body>
  ...
  <a class="navbar-brand" id="title01" href="http://10.68.14.67/novosicob/">
    <div class="h4"> Enviar Relatórios </div>
  </a>
</nav>
      <div class="container-fluid">
        ...
        <div class="row3">
          ...
          <figure id="figure_relat01"><a href="http://10.68.14.67/novosicob/corte_relig.php"><img src="imagens/slide_11.png" alt="imagem" class="img-thumbnail img_link_gerar_relat"><figcaption><div class="sombra_caption2">Carregar os arquivos de corte e susp. para o banco de dados!</div></figcaption></a></figure>

          <figure id="figure_relat01"><a href="http://10.68.14.67/novosicob/relat_relig.php"><img src="imagens/relat19.jpg" alt="imagem" class="img-thumbnail img_link_gerar_relat"><figcaption><div class="sombra_caption2">Carregar os arquivos de religacao para o banco de dados!</div></figcaption></a></figure>

          <figure id="figure_relat01"><a href="http://10.68.14.67/novosicob/uc_s_medicao.php"><img src="imagens/slide_16.jpeg" alt="imagem" class="img-thumbnail img_link_gerar_relat"><figcaption><div class="sombra_caption2">Atualizar e Baixar listagem de UC Sem Medicao</div></figcaption></a></figure>
