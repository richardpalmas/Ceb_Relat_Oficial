...
<body>
  ...
  <section class="corpo_meio_gerar_relat">
  ...
  <a class="navbar-brand" id="title01" href="http://10.68.14.67/novosicob/gerar_relat.php">
    <div class="h4"> Gerar Relatórios </div>
  </a>
</nav>
      <div class="container-fluid">
        ...
        <div class="row3">
          ...
          <figure id="figure_relat01"><a href="http://10.68.14.67/novosicob/tratrec_load.php"><img src="imagens/relat16.jpg" alt="imagem" class="img-thumbnail img_link_gerar_relat"><figcaption><div class="sombra_caption2">Relatório de Tratamento de Reclamações Anexo III </div></figcaption></a></figure>

          <figure id="figure_relat01"><a href="http://10.68.14.67/novosicob/tratrec_load_anexo_i.php"><img src="imagens/slide_14.jpg" alt="imagem" class="img-thumbnail img_link_gerar_relat"><figcaption><div class="sombra_caption2">Relatório de Tratamento de Reclamações Anexo I</div></figcaption></a></figure>

          <figure id="figure_relat01"><a href="http://10.68.14.67/novosicob/relat_gs.php"><img src="imagens/relat17.jpg" alt="imagem" class="img-thumbnail img_link_gerar_relat"><figcaption><div class="sombra_caption"> ANEXO III ART 32 </div></figcaption></a></figure>


          <figure id="figure_relat01" style="margin-top: -80px;"><a href="http://10.68.14.67/novosicob/relat_sap.php"><img src="imagens/relat17.jpg" alt="imagem" class="img-thumbnail img_link_gerar_relat"><figcaption><div class="sombra_caption"> RELATORIO SAP </div></figcaption></a></figure>
